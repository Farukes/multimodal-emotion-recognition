...
│
├── Sesmodel.py                 # Geriye dönük uyumluluk wrapper betiği
├── Görselmodel.py              # Geriye dönük uyumluluk wrapper betiği
├── Birleşikmodel.py            # Geriye dönük uyumluluk wrapper betiği
│
